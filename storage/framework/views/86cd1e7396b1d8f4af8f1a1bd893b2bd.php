...
<?php $__env->startSection('content'); ?>
    <div class="grid h-screen place-items-center">
        <div class="grid rounded-md w-[500px] shadow-md bg-white p-3">
            <form action="<?php echo e(route('register')); ?>" method="POST" class="grid gap-4">
                <?php echo csrf_field(); ?>
                <span class="text-xl">
                    Register
                </span>
                ...
                <div class="grid gap-3">
                    ...
                    <input type="text" name="name"  id="" class="border-2 p-2 rounded-md outline-gray-3000" value="<?php echo e(old('name')); ?>"/>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="grid gap-3">
                    <label for="Email" class="text-lg font-bold">Email</label>
                      <input type="email" name="email"  id="" class="border-2 p-2 rounded-md outline-gray-3000" value="<?php echo e(old('email')); ?>"/>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Tom\Desktop\laravel-login\resources\views/auth/register.blade.php ENDPATH**/ ?>